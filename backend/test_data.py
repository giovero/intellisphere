alunni = [
    [
        "Giovanni Rossi",
        30,
        "Questo studente è un genio e sarebbe opportuno fornire un quiz più complicato per lui.",
        "https://s3-alpha-sig.figma.com/img/f621/bdda/75dfbf7614cbd47aad1ee78575594fcd?Expires=1697414400&Signature=DBY3utqC2tyIFGNtEUhUM48qzHgc26cQJ~schAhVP3VLjMSViCsPIQ-kgIKyWW96hIKaRZtxX0cN0dTAidys9KvpA9dfC~im2WqfGuYHBF3eHrJLpSdxIMHLuIJcVuKWb4GD~LLc3AemceV9BHvOm9NZRCGq5joYHv-7TQsqK6pi--THUQ4DVRVi5NshbJlTijHJhmDdXuPAFKLB1yhbUsyRNs~8584m0SWIUDwJlhu-L5I2aPg1iTOgwdnX9jZYeL~q6CtmYgcQkNWXoIz2X4Txi4ANndM4mLuLECaMi7MRK2EdhnVwJnu7XQ~PXGVkCUpG6mcEZDW5UOSUfxFUPw__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4",
    ],
    [
        "Marco Bianchi",
        28,
        " Questo studente ha delle difficoltà di attenzione, sarebbe opportuno fornire domande brevi e chiare e esercizi semplificati.",
        "https://s3-alpha-sig.figma.com/img/49ea/3ccc/a15f777b5cb6a9eb61cc7d40b2aa62d2?Expires=1697414400&Signature=jxSwLbmsttO21Lg91uYLjiSgPRjHuotReXFHVuMuadD5EnevgwQLUwdKw-AF~1PAlcuHhfJt6IFMfEoHFmUlB4mHQ6vE8qGyYpdDUsSGkt5y~GPxS63xKUR7aL75Pv~g9KQUfSelEBn6IOZyz5K-egY-bWUpS0ZSEU~26V8NGJCvIVKjt9aL8GAx02IYfOqz-NL9ee0iiNKYCGj8CEj8dGRNuquhlbrh~ybDqJb2~71hEi9m~sVcV28x8jfZlNfBmrHCDoB1Be-pWDWjwf0X0mohkqVtPe~5BFoOAKkc54-QpJ4MPzBgt1dA3IxQ6WrEZXgfPqhuxUvc8kgcV0TdwQ__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4",
    ],
    [
        "Laura Esposito",
        32,
        "Questa studentessa sta facendo progressi ma ha bisogno di consolidare le basi prima di affrontare un quiz più difficile",
        "https://s3-alpha-sig.figma.com/img/713f/5eb3/acace5ff076951a42883b4c1d5f1cca1?Expires=1697414400&Signature=GA2nzqxGx9UKFXcVJHzJR2W~rFVAplGzjjYrPN0ARowQPYjj6dtqM9FixOiWEotWro8odyQ~bip~SsT5URbuUJGOFjZ0~pKXf1TKlEL-n9FBVESZOiHhKUfUp7R6XCI3CFlrD43reV1QKl64CK5krGLsz2n1fUY-R7jLOM4E1aTb3hI0Vi4oeiNTJ1kK0ajw9FFP8nnlc7lzr6AGgLNkiezezY-CwR-VuDEaxPPpmgGpiM48kO2huYPXbkGfERQbXoFRBGOJmuhzgsheqkhMrWSNxX9RhnrVKZ~8LtsOnFT9aIWwFZDb27MRTczfRTLbcqlUOxngo3yVUOcjDDoioQ__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4",
    ],
    [
        "Anna Martini",
        27,
        "Questa studentessa conosce molto bene le basi ma ha diverse carenze per quanto riguarda gli argomenti avnzati. Dovremmo potenziare quella parte.",
